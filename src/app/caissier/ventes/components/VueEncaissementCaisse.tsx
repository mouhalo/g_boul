...
const VueEncaissementCaisse: React.FC<VueEncaissementCaisseProps> = ({
  ...
  const loadEncaissements = async () => {
    ...
    try {
      ...
      // Pour le caissier, on limite toujours aux encaissements de son site
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Site (désactivé pour le caissier, juste affiché) */}
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">Site:</label>
            <div className="flex items-center">
              <input
                type="text"
                value={filterOptions.siteParams?.sites?.find(site => site.id_site === user?.id_site)?.nom_site || ""}
                disabled
