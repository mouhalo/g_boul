...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const profile = user?.libelle_profil?.toLowerCase() || '';
  ...
  const getMenuItems = () => {
    ...
    const profileMenus = {
      manager: [
        ...
        { icon: Package, label: 'Productions', href: `/${profile}/productions` },
    ...
    return [...commonItems, ...(profileMenus[profile as keyof typeof profileMenus] || [])];
  };
